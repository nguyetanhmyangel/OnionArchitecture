...
namespace OnionArchitecture.Application.Features.Functions.Queries.GetPaged
{
    ...
    public class GetFunctionQueryHandler : IRequestHandler<GetPageFunctionQuery, PaginatedResult<GetPageFunctionResponse>>
    {
        private readonly IFunctionRepository _repository;

        public GetFunctionQueryHandler(IFunctionRepository repository)
        {
